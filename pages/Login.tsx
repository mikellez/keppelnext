...
function Login({ databases, multi }: { databases: string[]; multi: boolean }) {
  ...
  if (
    ...
    localStorage.hasOwnProperty("feedback")
  ) {
  ...
  return (
    <>
      <div className={styles.loginContainer}>
          ...
          <form onSubmit={handleSubmit(formSubmit)}>
            {multi && (
              <div className={`form-group ${styles.group}`}>
                ...
                {errors.database && (
                  <div className={styles.loginErrorInfoText}>
        ...
        <div
          className={styles.loginMessageContainer}
          style={
            !(errorSubmitting && !isSubmitting) ? { visibility: "hidden" } : {}
          }
        >
          {errorSubmitting}
        </div>
