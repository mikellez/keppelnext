    ...
    <ModuleMain>
      <form onSubmit={handleSubmit(formSubmit)}>
        <ModuleHeader title="New Master Entry" header="Create New Master Entry">
          <Link href="/Master" className="btn btn-secondary">
            Back
          </Link>
        </ModuleHeader>
          ...
          <div className={formStyles.halfContainer}>
            <div className="form-group">
              ...
              <select
                ...
                id="formControlType"
                {...register("type", { required: true, onChange: changePlant })}
              >
          ...
          {masterType && ( //<MultiFields fields={props.tables[masterType].fields} />
            <Controller
              ...
              render={({
                ...
                <MultiFields
                  fields={props.tables[masterType].fields}
                  onChange={onChange}
...
export const getServerSideProps: GetServerSideProps = async (
  ...
  const masterCreateInfo = await instance.get<CMMSMasterTables>(
    `/api/master/new`,
    headers
  );
  ...
  const plants = await instance.get<CMMSPlant[]>(`/api/plants`, headers);

  let props: NewMasterEntryProps = {
    tables: masterCreateInfo.data,
