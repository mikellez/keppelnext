...
export const getServerSideProps: GetServerSideProps = async (
  ...
  if (type === undefined || id === undefined) return { notFound: true };
  ...
  const masterInfo = await instance.get<any>(
    `/api/master/` + type + "/" + id,
    headers
  );
  // console.log(masterInfo.data)
  if (masterInfo.status === 400) return { notFound: true };
