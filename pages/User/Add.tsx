...
export default function AddUser(props: AddUserProps) {
  ...
  async function submission() {
    try {
      let res = await instance.post("/api/user/addUser", form);
      // console.log(res);
  ...
  return (
    <ModuleMain>
      <ModuleHeader header="Add User" title="Add User"></ModuleHeader>
            ...
            <Select
              ...
              onChange={(e) => {
                ...
                setform((prevState) => {
                  return {
                    ...prevState,
                    allocatedPlants: e.map((p) => p.value),
                  };
                });
              }}
