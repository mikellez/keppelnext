...
export class SingleChoiceControl extends CheckControl {
	...
	clone() {
		return new SingleChoiceControl(this.question, this.choices, this.value, this.id);
	}
...
export function SingleChoice({singleChoiceObj, onChange, onDelete}: {
	...
	return <div className={checklistStyles.controlContainer}>
		...
		<div className="form-group">
			<input onChange={handleQuestion} className="form-control" defaultValue={singleChoiceObj.question} placeholder="Enter Question"/>
		</div>
