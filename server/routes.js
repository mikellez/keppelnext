...
router.get(
  "/request/types",
  checkIfLoggedInAPI,
  controllers.request.fetchRequestTypes
);
...
router.get(
  "/checklist/record",
  checkIfLoggedInAPI,
  controllers.checklist.fetchForReviewChecklists
);
router.get(
  "/checklist/approved",
  checkIfLoggedInAPI,
...
router.get(
  "/fault/types",
  checkIfLoggedInAPI,
  controllers.fault.fetchFaultTypes
);

router.get(
  "/asset/:plant_id",
  checkIfLoggedInAPI,
  controllers.asset.getAssetsFromPlant
);
