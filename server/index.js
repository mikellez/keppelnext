...
app.prepare().then(() => {
    ...
    server.delete("/api/master/:type/:id", checkIfLoggedInAPI, controllers.master.deleteMasterTypeEntry);
    ...
    server.route("/api/timeline/status/:status/:id?", checkIfLoggedInAPI)
